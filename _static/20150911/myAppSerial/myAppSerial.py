...
def myTry01(deb=1):
	...
	self = MyApp(width=700, height=400, title="myApp", 
	...
	def devTx(self):
		...
		try:
			...
			if self.bufDev:
				...
				# print data_str
				self.dev.sendListCommands(self.bufDev, sto="", log=0)
				# update counter
				self.couSnd += len(self.bufDev[0])
...
#myEntFrame (cmd Serial)
	...
	obje, othe = myEntFrame(name='ciao Mondo!', 
							numb=29,
